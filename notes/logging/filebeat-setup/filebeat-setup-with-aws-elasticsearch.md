## Setting up filebeat in kubernetes with AWS Elasticsearch Service

- Kubernetes resources metadata for filebeat with AWS ES

<b>filebeat-kubernetes-aws-es.yaml</b>
```
---
apiVersion: v1
kind: ConfigMap
    ...
    spec:
      ...
      - name: filebeat
        ...
        - name: ELASTICSEARCH_HOST
          value: https://search-demo-elastic-mgbhjvo6bassalcrg5sq4sgi3u.us-east-1.es.amazonaws.com
...
```
kubectl create -f filebeat-kubernetes-aws-es.yaml
```
